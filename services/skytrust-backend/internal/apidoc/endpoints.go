...
var Endpoints = []Endpoint{
	...
	{Path: "/api/crypto/sm9/verify", Group: "密码学", Summary: "SM9 验签。样例为确定性错误（畸形签名→1002）；成功路径见场景 TC1-03/TC1-04", Sample: map[string]any{"sm9_identity": "SM9-ID-UAV-A-001", "payload": map[string]any{"mission_id": "MISSION-2026-001", "operator_id": "Operator-A", "altitude_max": 120}, "signature": "!!!not-base64!!!"}, ExpectCode: 1002, ProbeExpect: 6002},
	{Path: "/api/demo/init", Group: "演示", Summary: "演示数据灌注（幂等 upsert）", Sample: map[string]any{}, ExpectCode: 0, ProbeExpect: 0},
	{Path: "/api/manufacturer/register", Group: "主数据", Summary: "制造商注册", Sample: map[string]any{"manufacturer_id": "Manufacturer-DOC", "name": "文档样例制造商"}, ExpectCode: 0, ProbeExpect: 6002},
	{Path: "/api/manufacturer/list", Group: "主数据", Summary: "制造商列表（分页）", Sample: map[string]any{}, ExpectCode: 0, ProbeExpect: 6002},
	{Path: "/api/operator/register", Group: "主数据", Summary: "运营商注册", Sample: map[string]any{"operator_id": "Operator-DOC", "name": "文档样例运营商"}, ExpectCode: 0, ProbeExpect: 6002},
