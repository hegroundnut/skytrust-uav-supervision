...
type Mission struct {
	...
	StartTime         timex.Time `json:"start_time"`
	EndTime           timex.Time `json:"end_time"`
...
type ReviewRecord struct {
	...
	ReviewTime    timex.Time `json:"review_time"`
}
...
type FlightPass struct {
	...
	ValidFrom timex.Time `json:"valid_from"`
	ValidTo   timex.Time `json:"valid_to"`
	Signature string     `gorm:"type:text" json:"signature"`
	SM3Hash   string     `gorm:"size:64" json:"sm3_hash"`
